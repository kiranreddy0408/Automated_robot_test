...
Verify Home link
    Click Element  xpath=//a[@href="http://dev5.gptfu.com:6080/"]
...
Verify logo link
    ...
    Click Element  xpath=//a[@href="http://dev5.gptfu.com:6080/" and contains(@class,'logo')]
    Page Should Contain  Latest Listings 
